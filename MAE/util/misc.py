...
def get_mae_model(type, random_mask=False, **kwargs):

    from MAE.models_mae import MaskedAutoencoderViT as mae

    if type == 'mae_vit_base_patch16':
        model = mae(patch_size=16, embed_dim=768, depth=8, num_heads=12,
                    decoder_embed_dim=512, decoder_depth=0, decoder_num_heads=16,
